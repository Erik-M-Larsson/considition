...
from random import random, shuffle, triangular
...
class ErikurStower:
    ...
    def __init__(self, game_info: dict) -> None:
        ...
        self._not_loaded_packages[29],self._not_loaded_packages[30]=self._not_loaded_packages[30], self._not_loaded_packages[29]
        self._not_loaded_packages[33],self._not_loaded_packages[34]=self._not_loaded_packages[34], self._not_loaded_packages[33]
        self._not_loaded_packages[27],self._not_loaded_packages[29]=self._not_loaded_packages[29], self._not_loaded_packages[27]
        self._not_loaded_packages[37],self._not_loaded_packages[38]=self._not_loaded_packages[38], self._not_loaded_packages[37]
        self._not_loaded_packages[28],self._not_loaded_packages[29]=self._not_loaded_packages[29], self._not_loaded_packages[28]
        self._not_loaded_packages[3],self._not_loaded_packages[5]=self._not_loaded_packages[5], self._not_loaded_packages[3]
        ...
        #self._not_loaded_packages[random_index+2], self._not_loaded_packages[random_index+3]=self._not_loaded_packages[random_index+3], self._not_loaded_packages[random_index+2]

        #temporary_list[random_index+1]=permutator
        
        #self._not_loaded_packages=temporary_list
        print(f"Paket nr {random_index} bytte plats med paket nr {random_index+1} och {random_index+2} bytte med {random_index+3}")
    ...
    def stow_truck(self) -> list:
        ...
        for p in packing_list:
            ...
            if len(tr.loaded_packages):  # Kolla om det redan finns paket på flaket annars lägg direkt på (0, 0, 0)
                ...
                placements = [{ "occupied volume" : None, "coordinates" : (0, 0, 0, p.dimensions[1], p.dimensions[0], p.dimensions[2])}]
