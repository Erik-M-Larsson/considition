...
o_space = cb.occu_space[2:cb.length,5:6, 2:6] +0# Volym från paket till bakgavel
p_behind =set(cb.occu_space[2:cb.length,5:6, 2:6][np.nonzero(o_space+1)]) # Hitta alla unika värden på paket bakom
